package com.webservice.xfire.handler;
...
//首先实现:添加头部逻辑
public class RequesterHeaderHandler implements SOAPHandler<SOAPMessageContext> {
    private String user;
    private String password;

    public RequesterHeaderHandler(String user, String password) {
        super();
        this.user = user;
