 ...
 * 
 */
@WebServiceClient(name = "UserServiceImplService", targetNamespace = "http://service.server.webservice.example.com/", wsdlLocation = "http://localhost:8080/service/user?wsdl")
    ...
    extends Service
{
    ...
    private final static QName USERSERVICEIMPLSERVICE_QNAME = new QName("http://service.server.webservice.example.com/", "UserServiceImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/service/user?wsdl");
    ...
    public UserService getUserServiceImplPort() {
        return super.getPort(new QName("http://service.server.webservice.example.com/", "UserServiceImplPort"), UserService.class);
    }
    ...
    public UserService getUserServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.server.webservice.example.com/", "UserServiceImplPort"), UserService.class, features);
    }
