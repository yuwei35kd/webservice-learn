...
public class GreetingImplService extends Service {
    ...
    public final static QName SERVICE = new QName("http://server.cxf.webservice.com/", "GreetingImplService");
    public final static QName GreetingImplPort = new QName("http://server.cxf.webservice.com/", "GreetingImplPort");
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GreetingImplService.class.getName())
                    .log(java.util.logging.Level.INFO,
                            "Can not initialize the default wsdl from {0}", "http://localhost:8080/webservice/Greeting?wsdl");
        }
        WSDL_LOCATION = url;
    }
