 ...
 * generated in the com.webservice.cxf.client package. 
...
public class ObjectFactory {
    ...
    private final static QName _Greeting_QNAME = new QName("http://server.cxf.webservice.com/", "greeting");
    private final static QName _GreetingResponse_QNAME = new QName("http://server.cxf.webservice.com/", "greetingResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.webservice.cxf.client
     * 
     */
     ...
     * @return
     *     the new instance of {@link JAXBElement }{@code <}{@link Greeting_Type }{@code >}
     */
    @XmlElementDecl(namespace = "http://server.cxf.webservice.com/", name = "greeting")
     ...
     */
    @XmlElementDecl(namespace = "http://server.cxf.webservice.com/", name = "greetingResponse")
